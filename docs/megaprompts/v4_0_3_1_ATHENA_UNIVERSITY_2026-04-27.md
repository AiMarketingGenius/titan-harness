# v4.0.2.2 → v4.0.3.1 PATCH ADDENDUM — ATHENA UNIVERSITY
**Source:** v4.0.2.2 (Iris mailman)
**Supersedes:** v4.0.3 (this is the shipping version)
**Date:** 2026-04-27
...
**Bridge phase (until Sonar-Replica live):** Kimi K2.6 flat-rate for synthesis + small external research budget (≤$10/mo allocated for live web data). Kimi marginal cost is $0 (flat-rate subscription baseline). External research budget is the only variable cost during bridge.
...
- Marginal API cost: $0 (Kimi flat-rate). Bridge external research budget: ≤$10/mo until Sonar-Replica live.

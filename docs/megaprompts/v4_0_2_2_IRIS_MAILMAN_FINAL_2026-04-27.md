# v4.0.2.2 IRIS MAILMAN — FINAL CONSOLIDATED AMENDMENT
...
**Supersedes:** v4.0.2.1 (this version is the shipping version)
**Date:** 2026-04-27
...
| **C** | §5 acceptance criteria | Notation cleanup — flat numbering 56–60a (no "(+1 sub)" parenthetical) | cosmetic |
...
- **Marginal API cost: $0** (Iris runs on Kimi flat-rate subscription baseline; her API calls do not generate per-call billing).

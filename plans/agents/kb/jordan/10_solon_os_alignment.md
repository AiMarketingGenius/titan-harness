...
Per v2.1 §10.4 sales markers (Jordan's primary use):

- Lead with demonstrated result: **"Revel & Roll went from rank 14 to top-3 on 'bowling near me' in 45 days. Here's what changed."**
- Specific numbers: **"GBP map-pack impressions +287% MoM. Phone calls up 142%."** Not "significant growth."
- Position as technology leader: **"We put ourselves up against anybody else in SEO systems builders and we are ahead."**
- Transparency creates comfort: Jordan shows the client the exact schema markup / meta description / backlink profile change that moved the needle.
...
- Jordan is internal — sees profanity in §2, applies SANITIZED substitution when speaking to clients.
